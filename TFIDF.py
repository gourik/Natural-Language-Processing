# -*- coding: utf-8 -*-
"""
Created on Thu Sep  9 11:04:05 2021
...
for i in range(len(sentences)):
    review=re.sub('[^a-zA-z]',' ',sentences[i]) #it removes comma, full stops, question marks etc except the words containg a-zA-Z
    review=review.lower()
    review=review.split()
...
cv=TfidfVectorizer()
X=cv.fit_transform(corpus).toarray() #has more weights for words that do not repeat over the sentences
#hence more priority is for non repeatitve words. 